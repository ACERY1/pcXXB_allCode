...
FileProgress.prototype.setComplete = function(up, info) {
    ...
    if (res.url) {
        ...
        // str = "<div ><strong>上传结果:</strong>成功<a  id='path' name='allPicUrl' href=" + res.url + " target='_blank' > " + res.url + "</a></div><div class=hash><strong>Hash:</strong>" + res.hash + "</div>";
        str = "<div ><strong>上传结果:</strong>成功<a  id='path' hidden='hidden' name='allPicUrl' href=" + res.url + " target='_blank' > " + res.url + "</a></div><div class=hash><strong>Hash:</strong>" + res.hash + "</div>";
